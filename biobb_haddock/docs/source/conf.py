...
man_pages = [(master_doc, "biobb_haddock", "biobb_haddock Documentation", [author], 1)]
...
texinfo_documents = [
    (
        ...
        author,
        "biobb_haddock",
        "biobb_haddock molecular dynamics building blocks",
        "Miscellaneous",
    ),
]
